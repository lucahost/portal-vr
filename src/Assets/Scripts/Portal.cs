...
public class Portal : MonoBehaviour {
    ...
    void CreateViewTexture () {
        if (viewTexture == null || viewTexture.width != Screen.width || viewTexture.height != Screen.height) {
            ...
            linkedPortal.screen.sharedMaterial.SetTexture ("_MainTex", viewTexture);
        }
    }
    ...
    /* OLD PORTAL CODE NEEDED FOR GUNS */
    ...
    public void Open()
    {
        ...
        var secondPortalGameObject = GameObject.FindGameObjectWithTag(isOrange ? "Blue Portal" : "Orange Portal");

        if (secondPortalGameObject)
        {
            var second = secondPortalGameObject.GetComponent<Portal>();
            if (second != null)
            {
                linkedPortal = second;
                second.linkedPortal = this;

                PrePortalRender();
                Render();
                PostPortalRender();

                second.PrePortalRender();
                second.Render();
                second.PostPortalRender();
            }
        }
    ...
    {
        tag = "Untagged";
        if (linkedPortal?.linkedPortal != null)
        {
